...
//check if button pressed
    if(isset($_REQUEST['submit'])){
        ...
        $job_company = $_SESSION['company_name'];
        $job_company_id=$_SESSION['company_id'];
...
<div class="container content mid-header">
    <hr/>
    <span style="font-size:25px; margin:20px 20px; font-family: 'Montserrat', sans-serif;">Make Job Request </span>
    <form class="form-horizontal" style="margin-top:10px;" name="frm" method="post" action="company_job_request_form.php" enctype="multipart/form-data">
